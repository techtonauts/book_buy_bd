...
@section('meta')
    <meta name="description"
        content="Welcome to BookBuyBD, your one-stop destination for all your book needs. Explore our wide range of books and enjoy a seamless shopping experience.">
    <meta name="keywords" content="books, online bookstore, BookBuyBD, buy books online">

@endsection

@section('title', 'Wlecome to BookBuyBD')

@section('content')
    <!-- banner -->
    <div class="bg-cover bg-no-repeat bg-center" style="background-image: url('{{ asset('images/hero_placeholder.png') }}');">
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('images/hero_placeholder.png') }}" alt="product 1" class="w-full">
                    <div
